...
export interface UpdateHoldArgs {
    data: UpdateHoldInput;
    id: string;
}
...
export interface CreatePackagingArgs {
    data: CreatePackagingInput;
}
export interface UpdatePackagingArgs {
...
export interface UpdateRecipeVersionArgs {
...
export interface CreateProductionLineArgs {
    data: CreateProductionLineInput;
}
export interface UpdateProductionLineArgs {
