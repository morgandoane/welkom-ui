...
const ItemConversions = (props: ItemConversionsProps): ReactElement => {
    ...
    const [removeConversion, { loading: deleteLoading }] =
        useConversionDeletion({
                    ...
                    >
                        <ListItemText>
                            {`1 ${BaseUnits[conversion.to][0]} of ${
                                ...
                                BaseUnits[conversion.from][
                                    conversion.from_per_to == 1 ? 0 : 1
                                ]
                            }`}
                        </ListItemText>
                    </ListItem>
