...
const QualityCheckForm = (): ReactElement => {
    ...
    const getHoldup = (): string | null => {
        ...
        if (!state.prompt || !state.prompt.phrase)
                            ...
                            <Box>
                                ...
                                <FormRow gap={gap}>
                                    <Typography
                                        ...
                                        color="textSecondary"
                                    >
                                        Each time a lot of this item is created,
                                        this quality check will be asked.
                                    </Typography>
                                </FormRow>
                            </Box>
                        ),
                        content: (
                            <Box sx={{ maxWidth: 500 }}>
                                ...
                                <Collapse
                                    in={
                                        state.prompt &&
                                        state.prompt.type !== PromptType.Text
                                    }
                                >
                                    <FormRow>
                                        <BooleanField
