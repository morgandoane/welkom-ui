    ...
    return (
        <Box sx={{ paddingTop: 4 }}>
                ...
                {[
                    ...
                    { key: 'Spanish', value: unit.spanish },
                    {
                        ...
                        value: `${fraction(unit.base_per_unit)} ${
                            BaseUnits[unit.class][
                                unit.base_per_unit == 1 ? 0 : 1
                            ]
                        }`,
                    },
            ...
            <SideDrawer
                ...
                success={
                    result && result.success == true ? 'Unit saved' : undefined
                }
            >
                <PanelHeader
                    onClose={onClose}
                >{`Update ${unit.english}`}</PanelHeader>
                <Box p={1} />
                <FormRow>
                    <TextFormField
                        disabled={loading}
                    ...
                    <NumberField
                        label={
                            state && state.data.class !== undefined
                                ? `${BaseUnits[state.data.class][1]} per ${
                                      state.data.english
                                  }`
                                : ''
                        }
