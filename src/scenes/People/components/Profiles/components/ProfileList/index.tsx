        ...
        {{
          header: (
            <Box sx={{ paddingBottom: 2 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Box sx={{ flex: 1 }} />
                <Box>
                  <Button onClick={() => nav("new")} endIcon={<MdAdd />}>
                    New profile
                  </Button>
                </Box>
              </Box>
          ...
          content: (
            <DataGrid
              ...
              error={error}
              loading={loading}
              rows={profiles.map((o) => ({ ...o, id: o.user_id || "" }))}
              onRowClick={(params) => nav(params.row.user_id)}
              columns={[
                { field: "name", headerName: "Account Name", width: 220 },
                { field: "given_name", headerName: "Given Name", width: 120 },
                { field: "family_name", headerName: "Family Name", width: 120 },
                { field: "email", headerName: "Email", width: 220 },
                { field: "roles", headerName: "Role", width: 100 },
                { field: "blocked", headerName: "Blocked", width: 100 },
                {
                  field: "last_login",
                  ...
                  valueGetter: (params) =>
                    params.row.last_login
                      ? format(
                          new Date(params.row.last_login),
                ...
                },
                {
                  ...
                  width: 140,
                  valueGetter: (params) =>
                    params.row.last_ip ? params.row.last_ip : "",
                },
                {
