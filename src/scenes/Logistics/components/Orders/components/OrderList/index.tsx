...
const OrderList = (): ReactElement => {
    ...
    const showChips = () => {
        ...
        if (
            Object.values(rest).some((val) => val !== null && val !== undefined)
        )
            return true;
        else return false;
    };
                ...
                {{
                    header: (
                        <Box>
                            ...
                            >
                                This table shows all orders, whether they were
                                created automatically in the queue, or manually
                                in a form.
                            </Typography>
                        </Box>
                    ),
                                            ...
                                            {showChips() ? (
                                                ...
                                                >
                                                    {Object.keys(
                                                        ...
                                                        return filterChips[
                                                            key as keyof typeof filterChips
                                                        ];
                                                    })}
                                                </Box>
                                            ) : (
                ...
                <Filters>
                    {{
                        Customer: [
                            ...
                            />,
                            filterEdits !== null &&
                                filterEdits.customer !== undefined,
                            (checked) => {
                                if (filterEdits) {
                                    setFilterEdits({
                                        ...filterEdits,
                        ...
                        Vendor: [
                            <CompanyField
                                ...
                                key="vendorFilter"
                                value={
                                    filterEdits ? filterEdits.vendor || '' : ''
                                }
                                onChange={(val) => {
                                    if (filterEdits)
                                        setFilterEdits({
                        ...
                        ['Due date range']: [
                            <DateRangeField
                                ...
                                key="itemFilter"
                                value={
                                    filterEdits ? filterEdits.due || null : null
                                }
                                onChange={(val) => {
                                    if (filterEdits)
                                        setFilterEdits({
